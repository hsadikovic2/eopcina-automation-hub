        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElektronskiPotpis = table.Column<string>(type: "text", nullable: false),
                    BrojLicneKarte = table.Column<string>(type: "text", nullable: false),
                    RokTrajanjaLicneKarte = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Spol = table.Column<int>(type: "integer", nullable: false),
                    AdresaPrebivalista = table.Column<string>(type: "text", nullable: false),
                    Zakljucan = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PDFSablona = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RokTrajanja = table.Column<int>(type: "integer", nullable: false),
                    PDFDokumenta = table.Column<byte[]>(type: "bytea", nullable: false),
                    IdSablona = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdDokumenta = table.Column<int>(type: "integer", nullable: false),
                    RazlogZahtjeva = table.Column<int>(type: "integer", nullable: false),
                    StanjeZahtjeva = table.Column<int>(type: "integer", nullable: false),
